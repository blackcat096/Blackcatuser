...
async def run_bot():
    ...
    full_info = f"""black cat Based On Pyrogram V{__version__}
Python Version : {platform.python_version()}
black cat Version : {friday_version}
You Can Visit @catmusicworld For Updates And @The_cat_lover0 For Any Query / Help!
"""
